...
void db_lnode_flush(db_list_t* ,int ,void* );
void db_list_delete(db_list_t** ,int );
void db_list_destory(db_list_t* );
void* db_list_visit(db_list_t** ,int );
void db_list_travel(db_list_t** ,void(*do_function)(void* ));
